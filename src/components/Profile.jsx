...
export default function Profile({ data }) {
  ...
  return (
    <div className='flex flex-col items-center pt-6'>
        ...
        <div className='bg-[#13181f] w-full md:w-10/12 lg:w-8/12 xl:w-6/12 my-6 flex flex-col items-center py-6 '>
            ...
            <div className='bg-[#1e2633] py-2 w-full md:w-11/12 flex flex-col sm:flex-row space-y-0.5 sm:space-y-0 sm:space-x-1 items-center whitespace-nowrap'>
