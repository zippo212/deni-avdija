...
export default function SeasonTotals({ data }) {
  ...
  const title = ['CURRENT SEASON','All Season Stats',`SEASON ${data.SEASON_ID}`]
  ...
  return (
    <div className='flex flex-col items-center pt-6'>
        <h4 className='text-[#ffd600] font-semibold'>Stats</h4>
        <div className='bg-[#13181f] h-80 md:h-86 lg:h-[22rem] w-full md:w-10/12 lg:w-9/12 xl:w-7/12 2xl:w-6/12 my-6 flex flex-col items-center py-6 space-y-7 z-40'>
